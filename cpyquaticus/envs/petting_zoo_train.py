...
from clean_ppo import PPO, PPOAgent, PPOArgs
from faster_envs import Cpyquaticus
from ma_summary_writer import MultiAgentSummaryWriter
from BasePolicies import DoNothing
@dataclass
class Args:
...
#TODO fix SummaryWriter for decentralized TF outputs
...
if __name__ == "__main__":
    ...
    #writer.close()
    print("Time for 25M Training Steps ", time.time() - start_time)
    for a in agents:
        if a in args.to_train:
