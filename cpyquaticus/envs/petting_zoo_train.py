...
from dict_based_sequential import SequentialMultiEnv
from clean_ppo import PPO, PPOArgs
...
class Args:
    ...
    #Agent Config
    possible_agents = {'default':(PPO, PPOArgs)}
...
if __name__ == "__main__":
    ...
    if args.env_id == 'cpyquaticus':
        ...
        for a in args.possible_agents:
            agents[a] = args.possible_agents[a][0](args.possible_agents[a][1])
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for a in agents:
            if args.anneal_lr:
                ...
                agents[a].optimizer.param_groups[0]['lr'] = lrnow
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                action, logprob, _, value = agent.get_action_and_value_train(next_obs)
                #values[step] = value.flatten()
            #actions[step] = action
            #logprobs[step] = logprob

            # TRY NOT TO MODIFY: execute the game and log data.
            #TODO add next_obs, reward, term, trunc, to clean_ppo.py
